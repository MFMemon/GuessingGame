...
public class Game {
    ...
    private int imageRevealFactor; // factor by which the tiles will be revealed
    ...
    /**
     * Setter and getter for the won flag
     * @param args Unused.
     * @return Nothing.
     */
    ...
    public synchronized void setImageRevealFactor(float factor){
        int remainingIdx = getIdxMax() - getIdx();        
        imageRevealFactor = (int)(remainingIdx/factor) + 1 ;
    }

    public int getImageRevealFactor(){
        return imageRevealFactor;
    }
     ...
     * @return String of the current hidden image
     */
    public synchronized String replaceOneCharacter() {
